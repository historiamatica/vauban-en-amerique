...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-17402436.863532, 1721547.794038, -2714376.364595, 9419616.584581], maxZoom: 12, minZoom: 4
    })
});
...
map.getView().fit([-17402436.863532, 1721547.794038, -2714376.364595, 9419616.584581], map.getSize());
